...
""",
            ...
            "nested_itemize_error": """
# Nested Lists Error

:itemize:
:-: Outer item 1
:itemize:
:-: Inner item - this nesting might cause issues
:-: Another inner item
::
:-: This item might be malformed due to nesting
""",
...
:-: Item 1
:enumerate:
:-: This enumerate inside itemize might cause issues
::
:-: Back to itemize
::
...
:itemize:
:-: Item with *emphasis* and **bold**
:-: Item with `code` and &special; entities
::
...
"""
    ...
    async def test_extremely_large_malformed_document(self, db_session: AsyncSession):
        ...
        large_malformed = ["# Large Malformed Document"]
...
:itemize:
:-: Item with <strong>HTML</strong>
:-: Item with <em onclick="alert('xss')">JavaScript</em>
::
